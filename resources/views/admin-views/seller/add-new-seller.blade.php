...
<div class="content container-fluid main-card {{Session::get('direction')}}">
    ...
    <form class="user" action="{{route('admin.sellers.add')}}" method="post" enctype="multipart/form-data" id="add-vendor-form">
        @csrf
        <div class="card">
            <div class="card-body">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center justify-content-end gap-10">
                    ...
                    <button type="button" class="btn btn--primary btn-user form-submit" data-form-id="add-vendor-form" data-redirect-route="{{route('admin.sellers.seller-list')}}"
