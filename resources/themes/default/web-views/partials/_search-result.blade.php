<ul class="list-group list-group-flush">
    @foreach ($products as $product)
        <li class="list-group-item nk px-0 overflow-hidden">
                <a href="{{url('/product/'.$product['slug'])}}" class="btn p-0 m-0 search-result-product-button align-items-baseline text-start"
