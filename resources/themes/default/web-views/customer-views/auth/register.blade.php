            ...
            <div class="mx-auto __max-w-760">
                ...
                <form class="needs-validation_" id="customer-register-form" action="{{ route('customer.auth.sign-up') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="form-label font-semibold">{{ translate('password') }} <small
                                        class="text-danger mx-1 password-error"></small></label>
                            ...
                            <div class="col-sm-6">
                                <div class="rtl">
                                    <label class="custom-control custom-checkbox m-0 d-flex">
                                        <input type="checkbox" class="custom-control-input" name="is_business"
                                            value="1" id="im_business">
                        ...
                        <div class="row" style="display: none" id="business_name_div">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control text-align-direction" value="{{ old('business_name') }}"
                                        type="text" name="business_name"
                                        placeholder="{{ translate('Ex') }}: {{ translate('jhone_shop') }}"
                                        id="business_name">
                                    <div class="invalid-feedback">{{ translate('please_enter_your_business_name') }}!
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Trade license (optional)</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input " name="trade_license" accept=".jpg, .png, .jpeg, .pdf">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="tax_certificate" accept=".jpg, .png, .jpeg, .pdf">
                                        <label class="custom-file-label">Upload Tax certificate</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>TRN certificate (optional)</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" name="trn_certificate" accept=".jpg, .png, .jpeg, .pdf">
